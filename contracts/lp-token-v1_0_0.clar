...
(define-public (transfer
    ...
    (begin
        ...
        (try! (ft-transfer? LPT amount sender recipient))
        (match memo
...
(define-read-only (get-balance (who principal))
    (ok (ft-get-balance LPT who))
)

(define-read-only (get-total-supply)
    (ok (ft-get-supply LPT))
)
